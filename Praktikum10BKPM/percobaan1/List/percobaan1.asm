...
; 0000 0031 // Func7=In Func6=In Func5=In Func4=In Func3=In Func2=Out Func1=In Func0=In
; 0000 0032 // State7=T State6=T State5=T State4=T State3=T State2=1 State1=P State0=T
; 0000 0033 PORTC=0x06;
	LDI  R30,LOW(6)
	OUT  0x15,R30
; 0000 0034 DDRC=0x04;
	LDI  R30,LOW(4)
...
; 0000 008A PORTC.2=1;
	SBI  0x15,2
; 0000 008B delay_us(2000);
	__DELAY_USW 5530
; 0000 008C PORTC.2=0;
	CBI  0x15,2
; 0000 008D delay_us(1000);
	__DELAY_USW 2765
; 0000 008E }
	MOVW R30,R4
	ADIW R30,1
...
; 0000 0090 PORTC.2=1;
	SBI  0x15,2
; 0000 0091 delay_us(1000);
	__DELAY_USW 2765
; 0000 0092 PORTC.2=0;
	CBI  0x15,2
; 0000 0093 delay_us(2000);
	__DELAY_USW 5530
; 0000 0094 }
	MOVW R30,R4
	ADIW R30,1
