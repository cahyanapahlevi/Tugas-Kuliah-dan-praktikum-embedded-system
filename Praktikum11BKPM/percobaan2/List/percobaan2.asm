...
; 0000 003D // Func7=In Func6=In Func5=In Func4=Out Func3=In Func2=Out Func1=In Func0=In
; 0000 003E // State7=T State6=T State5=T State4=1 State3=T State2=1 State1=T State0=T
...
; 0000 0098       DIRA=0; DIRB=1; pwm=255;
	CBI  0x15,2
	SBI  0x15,4
	LDI  R30,LOW(255)
	RCALL SUBOPT_0x0
; 0000 0099 delay_ms(1000);
; 0000 009A DIRA=0; DIRB=1; pwm=50;
	SBI  0x15,4
	LDI  R30,LOW(50)
	RCALL SUBOPT_0x0
; 0000 009B delay_ms(1000);
; 0000 009C DIRA=0; DIRB=0; pwm=0;
	CBI  0x15,4
	CLR  R4
