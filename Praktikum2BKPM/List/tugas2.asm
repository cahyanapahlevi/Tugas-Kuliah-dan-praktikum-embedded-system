...
; 0000 0087         // KONDISI 1
; 0000 0088       PORTA = 0b110; //MERAH
	LDI  R30,LOW(6)
	OUT  0x1B,R30
; 0000 0089       PORTB = 0b011; //HIJAU
	LDI  R30,LOW(3)
	RCALL SUBOPT_0x0
; 0000 008A       PORTC = 0b110; //MERAH
; 0000 008B       delay_ms(3000);
; 0000 008C 
; 0000 008D       //KONDISI 2
; 0000 008E       PORTA = 0b101; //KUNING
	LDI  R30,LOW(5)
	OUT  0x1B,R30
; 0000 008F       PORTB = 0b101; //KUNING
	RCALL SUBOPT_0x0
; 0000 0090       PORTC = 0b110; //MERAH
; 0000 0091       delay_ms(3000);
; 0000 0092 
; 0000 0093       //KONDISI 3
; 0000 0094       PORTA = 0b011; //HIJAU
	LDI  R30,LOW(3)
	OUT  0x1B,R30
; 0000 0095       PORTB = 0b110; //MERAH
	LDI  R30,LOW(6)
	OUT  0x18,R30
; 0000 0096       PORTC = 0b101; //KUNING
	LDI  R30,LOW(5)
	OUT  0x15,R30
...
; 0000 0098 
; 0000 0099       //KONDISI 4
; 0000 009A       PORTA = 0b101; //KUNING
	LDI  R30,LOW(5)
	OUT  0x1B,R30
; 0000 009B       PORTB = 0b101; //KUNING
	OUT  0x18,R30
; 0000 009C       delay_ms(1000);
	LDI  R26,LOW(1000)
	LDI  R27,HIGH(1000)
	CALL _delay_ms
; 0000 009D       PORTA = 0b110; //MERAH
	LDI  R30,LOW(6)
	OUT  0x1B,R30
; 0000 009E       PORTB = 0b110; //MERAH
	OUT  0x18,R30
; 0000 009F       PORTC = 0b011; //HIJAU
	LDI  R30,LOW(3)
	OUT  0x15,R30
