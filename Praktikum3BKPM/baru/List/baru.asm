...
; 0000 002A // Func7=In Func6=In Func5=Out Func4=Out Func3=Out Func2=Out Func1=In Func0=In
; 0000 002B // State7=T State6=T State5=0 State4=0 State3=0 State2=0 State1=T State0=T
...
; 0000 0088           if(PINC.0 == 0){
	SBIS 0x13,0
; 0000 0089           PORTB = 0;
	RCALL SUBOPT_0x0
; 0000 008A           delay_ms(100);
; 0000 008B           }
; 0000 008C           if(PINC.1 == 0) {
	SBIC 0x13,1
	RJMP _0x7
; 0000 008D           PORTB = 255;
	LDI  R30,LOW(255)
