...
; 0000 002B // Func7=In Func6=In Func5=Out Func4=Out Func3=Out Func2=Out Func1=In Func0=In
; 0000 002C // State7=T State6=T State5=0 State4=0 State3=0 State2=0 State1=T State0=T
...
; 0000 0089       for(x=0;x<=4;x++){
	CLR  R5
_0x8:
	LDI  R30,LOW(4)
	CP   R30,R5
	BRLO _0x9
; 0000 008A       data=led[x];
	MOV  R30,R5
	LDI  R31,0
	SUBI R30,LOW(-_led)
	SBCI R31,HIGH(-_led)
	LD   R4,Z
; 0000 008B       PORTB=data;
	OUT  0x18,R4
