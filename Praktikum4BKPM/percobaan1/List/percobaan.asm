...
_0x0:
	.DB  0x42,0x45,0x4C,0x41,0x4A,0x41,0x52,0x0
	.DB  0x4D,0x49,0x4B,0x52,0x4F,0x4B,0x4F,0x4E
	.DB  0x54,0x52,0x4F,0x4C,0x45,0x52,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 0096        lcd_gotoxy(0,0);lcd_putsf("BELAJAR");
	LDI  R30,LOW(0)
	ST   -Y,R30
	LDI  R26,LOW(0)
	RCALL _lcd_gotoxy
	__POINTW2FN _0x0,0
	RCALL _lcd_putsf
; 0000 0097        lcd_gotoxy(2,1);lcd_putsf("MIKROKONTROLER");
	LDI  R30,LOW(2)
	ST   -Y,R30
	LDI  R26,LOW(1)
	RCALL _lcd_gotoxy
