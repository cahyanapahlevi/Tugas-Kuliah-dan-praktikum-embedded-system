...
_0x0:
	...
	.DB  0x54,0x6F,0x6D,0x62,0x6F,0x6C,0x20,0x31
	.DB  0x20,0x44,0x69,0x74,0x65,0x6B,0x61,0x6E
	.DB  0x0,0x54,0x6F,0x6D,0x62,0x6F,0x6C,0x20
	.DB  0x32,0x20,0x44,0x69,0x74,0x65,0x6B,0x61
	.DB  0x6E,0x0,0x54,0x6F,0x6D,0x62,0x6F,0x6C
	.DB  0x20,0x0,0x54,0x69,0x64,0x61,0x6B,0x20
	.DB  0x64,0x69,0x74,0x65,0x6B,0x61,0x6E,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 0091 lcd_init(16);
	LDI  R26,LOW(16)
	RCALL _lcd_init
; 0000 0092 lcd_gotoxy(4,0);lcd_putsf("WELCOME");
	LDI  R30,LOW(4)
	RCALL SUBOPT_0x0
	__POINTW2FN _0x0,0
	RCALL SUBOPT_0x1
...
; 0000 0098       if(PIND.0==1){
	SBIS 0x10,0
	RJMP _0x6
; 0000 0099       lcd_gotoxy(0,0);lcd_putsf("Tombol 1 Ditekan");
	LDI  R30,LOW(0)
	RCALL SUBOPT_0x0
	__POINTW2FN _0x0,8
	RCALL SUBOPT_0x1
; 0000 009A       lcd_clear();
; 0000 009B       }
; 0000 009C       if(PIND.1==1){
_0x6:
	SBIS 0x10,1
	RJMP _0x7
; 0000 009D       lcd_gotoxy(0,0);lcd_putsf("Tombol 2 Ditekan");
	LDI  R30,LOW(0)
	RCALL SUBOPT_0x0
	__POINTW2FN _0x0,25
	RCALL SUBOPT_0x1
...
; 0000 00A0       else{
	RJMP _0x8
_0x7:
; 0000 00A1       lcd_gotoxy(0,0);lcd_putsf("Tombol ");
	LDI  R30,LOW(0)
	RCALL SUBOPT_0x0
	__POINTW2FN _0x0,42
	RCALL _lcd_putsf
; 0000 00A2       lcd_gotoxy(0,1);lcd_putsf("Tidak ditekan");
	LDI  R30,LOW(0)
	ST   -Y,R30
	LDI  R26,LOW(1)
	RCALL _lcd_gotoxy
