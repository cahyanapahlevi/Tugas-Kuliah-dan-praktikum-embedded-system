...
_0x0:
	.DB  0x54,0x69,0x6D,0x65,0x72,0x30,0x0,0x25
	.DB  0x34,0x64,0x0
_0x2020003:
	.DB  0x80,0xC0
...
; 0000 0037 // Func7=In Func6=Out Func5=Out Func4=Out Func3=Out Func2=Out Func1=In Func0=In
; 0000 0038 // State7=T State6=0 State5=0 State4=0 State3=0 State2=0 State1=T State0=T
...
; 0000 0095 // RS - PORTD Bit 0
; 0000 0096 // RD - PORTD Bit 1
; 0000 0097 // EN - PORTD Bit 2
; 0000 0098 // D4 - PORTD Bit 4
; 0000 0099 // D5 - PORTD Bit 5
; 0000 009A // D6 - PORTD Bit 6
; 0000 009B // D7 - PORTD Bit 7
...
; 0000 00A5        if(data>=100) {nilai++; data=0;}
	LDI  R30,LOW(100)
	LDI  R31,HIGH(100)
	CP   R4,R30
	CPC  R5,R31
...
_0x6:
	...
	LDI  R26,LOW(0)
	CALL _lcd_gotoxy
; 0000 00A7 lcd_putsf("Timer0");
	__POINTW2FN _0x0,0
	CALL _lcd_putsf
; 0000 00A8 sprintf(lcd,"%4d", nilai);
	LDI  R30,LOW(_lcd)
	LDI  R31,HIGH(_lcd)
	ST   -Y,R31
	ST   -Y,R30
