...
; 0000 0024 // State7=1 State6=1 State5=1 State4=1 State3=1 State2=1 State1=1 State0=1
...
; 0000 0030 // State7=1 State6=1 State5=1 State4=1 State3=1 State2=1 State1=1 State0=1
...
; 0000 0087 
; 0000 0088 
; 0000 0089       PORTA = 0b110;  // abang
	LDI  R30,LOW(6)
	OUT  0x1B,R30
; 0000 008A       PORTB = 0b011;    // ijo
	LDI  R30,LOW(3)
	RCALL SUBOPT_0x0
; 0000 008B       PORTC = 0b110;       //abang
; 0000 008C       delay_ms (3000);
; 0000 008D 
; 0000 008E       // kondisi kedua
; 0000 008F       PORTA = 0b101;   //      kuning
	LDI  R30,LOW(5)
	OUT  0x1B,R30
; 0000 0090       PORTB = 0b101;      //  kuning
	RCALL SUBOPT_0x0
; 0000 0091        PORTC = 0b110;       //   abang
; 0000 0092       delay_ms (3000);
; 0000 0093 
; 0000 0094       //kondisi ketiga
; 0000 0095        PORTA = 0b011;  // ijo
	LDI  R30,LOW(3)
	OUT  0x1B,R30
; 0000 0096       PORTB = 0b110;       // abang
	LDI  R30,LOW(6)
	OUT  0x18,R30
; 0000 0097        PORTC = 0b101;      // kuning
	LDI  R30,LOW(5)
	OUT  0x15,R30
...
; 0000 009B 
; 0000 009C 
; 0000 009D       // kondisi keempat
; 0000 009E       PORTA = 0b101;  // kuning
	LDI  R30,LOW(5)
	OUT  0x1B,R30
; 0000 009F       PORTB = 0b101;       // kuning
	OUT  0x18,R30
; 0000 00A0       delay_ms (1000);
	LDI  R26,LOW(1000)
	LDI  R27,HIGH(1000)
	CALL _delay_ms
; 0000 00A1       PORTA = 0b110;  // merah
	LDI  R30,LOW(6)
	OUT  0x1B,R30
; 0000 00A2       PORTB = 0b110;       // merah
	OUT  0x18,R30
; 0000 00A3        PORTC = 0b011;      // ijo
	LDI  R30,LOW(3)
	OUT  0x15,R30
; 0000 00A4       delay_ms (3000);
	...
	CALL _delay_ms
; 0000 00A5 
; 0000 00A6        /* kondisi kelima
; 0000 00A7       PORTA = 0b110;  // merah
; 0000 00A8       PORTB = 0b110;       // merah
; 0000 00A9       PORTC = 0b011;      // ijo
; 0000 00AA       delay_ms (3000);
; 0000 00AB          */
; 0000 00AC 
; 0000 00AD 
; 0000 00AE 
